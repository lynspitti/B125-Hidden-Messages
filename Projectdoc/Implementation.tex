...
% Valget af Instragram som leverandør
...
Flowcharts gennemgang af funktionaliterne\\
- Et login \\
- Send / modtag \\
- Tilfælde med oprettelse af nyt tråd kontra eksisterede tråd \\
- Slette request \\
- private beskeder (måske)\\
