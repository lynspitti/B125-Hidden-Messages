...
\\\\
Systemet beskrevet ved [Figur \ref{fig:sysdiagram}] er hovedsageligt designet efter et User Activity Action Event Flow. 
Dette vil sige at alle systemets aktiviteter er baseret på en brugers aktive handlinger, og kan derved styres fra et centralt sted. Her tales om enten brugerens egen enhed, eller en central system server, der ikke fortager andre handlinger end at responderer klart på en brugers kommandoer.
